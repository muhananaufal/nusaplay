...
export const ProvinceDestinations = ({ visible }) => {
  ...
  }, [selectedProvince?.id, stampProvince]);
            ...
            <div ref={sliderRef} className="pd-thumbnails-row">
              {categoryData.map((cat, index) => {
                ...
                return (
                  <div
                    key={cat.name}
                    className={`pd-thumbnail-item ${isActive ? 'active' : ''}`}
